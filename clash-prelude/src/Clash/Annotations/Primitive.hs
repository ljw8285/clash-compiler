...
data Primitive
  ...
  deriving (Show, Read, Data, Generic, NFData, Eq, Hashable)
...
data PrimitiveGuard a
  ...
  -- ^ Marks a value as having a blackbox. Clash will error if it hasn't found
  -- a blackbox.
    deriving (Show, Read, Data, Generic, NFData, Eq, Hashable, Functor, Foldable, Traversable, Binary)
...
data PrimitiveWarning
  ...
  -- ^ Always emit warning upon primitive instantiation.
    deriving (Show, Read, Data, Generic, NFData, Eq, Hashable, Binary)
