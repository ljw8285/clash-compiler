...
opsB8 = RamRead 8 :> (replicate d10 NoOp)

-- Test 9
opsA9 = twice (RamRead 9 :> Nil) ++ (zipWith RamWrite addrsA $ twice valuesB)
opsB9 = RamRead 9 :> (replicate d10 NoOp)

-- Test 10
opsA10 = twice (RamRead 10 :> Nil) ++ (replicate d20 NoOp)
opsB10 = RamRead 10 :> (zipWith RamWrite addrsB $ take d10 valuesA)

-- Test 11
opsA11 = twice (RamRead 11 :> Nil) ++ replicate d20 NoOp
...
opsB = (NoOp :> opsB0) ++ opsB1 ++ opsB2 ++ opsB3 ++ opsB4 ++ opsB5 ++ opsB6
